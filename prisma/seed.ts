    ...
    data: [
      {
        ...
        description:
          'Pudełeczko urodzinowe w formie kartki pop-up. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 10,
      },
      {
        ...
        description:
          'Pudełko ślubne exlpoding box. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 5,
      },
      {
        ...
        description:
          'Pudełeczko urodzinowe - czekoladownik. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 2,
      },
      {
        name: 'Grillopak',
        ...
        description:
          'Pudełeczko Grillopak, idealne na letnie przyjęcia. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 8,
      },
      {
      ...
      },
      {
        ...
        description:
          'Kwadratowa kartka w kopercie jako pamiątka Bierzmowania. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 1,
      },
      {
        name: 'Kartka Roczek',
        ...
        description:
          'Kartka na roczek w kształcie cyfry 1. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 10,
      },
      {
        name: 'Kartka Komunia',
        ...
        description:
          'Kwadratowa kartka na Pierwszą Komunię. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 7,
      },
      {
        ...
        description:
          'Walentynkowa kartka w formacie B5. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 1,
      },
      {
        name: 'Kartka Ślubna',
        ...
        description:
          'Ślubna kartka w pudełku. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 0,
      },
      {
        ...
        description:
          'Kartka dla maluszka z okazji narodzin lub przyjęcia Chrztu Świętego. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 6,
      },
      {
        ...
        description:
          'Ślubna kartka w pudełku, ze zdejmowanym wianuszkiem w kształcie serca. Podaj szczegóły personalizacji w polu "Życzenia" w podsumowaniu zamówienia.',
        quantity: 10,
      },
    ],
  });
